  ...
  return (
    <div className="relative w-[25rem] md:w-[80rem] flex justify-center mx-auto marquee">
      ...
      {testimonialData.map((data) => (
        ...
        <div key={data.id} className=" flex flex-col justify-center items-center w-[25rem] h-[17rem] rounded-2xl bg-gradient-to-t from-blue-700 via-blue-600 to-blue-500">
