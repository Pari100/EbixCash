      ...
      <div className="w-full h-140 md:h-170 flex justify-center" style={imageprop}>
        ...
        <div className="absolute top-30 md:top-40 text-center flex justify-center items-center flex-col" style={{zIndex: 10}}>
          ...
          <div className="w-[24rem] md:w-full max-w-[1200px] h-[170px] rounded-2xl m-auto movingCards flex justify-center items-center gap-8 overflow-hidden mt-[10px]" style={{zIndex: 10}}>
             ...
             <div className="bg-blue-800  border-[0.1px] border-blue-400 rounded-xl  w-40 h-22 md:h-25  gradient-border px-4 flex-shrink-0 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${finance})`}}><span className='cardtext'>Finance</span></div>
             <div className="bg-blue-800  border-[0.1px] border-blue-400 rounded-xl  w-40 h-22 md:h-25  gradient-border px-4 flex-shrink-0 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${bitcoin})`}}><span className='cardtext'>Forex</span></div>
             <div className="bg-blue-800  border-[0.1px] border-blue-400 rounded-xl  w-40 h-22 md:h-25  gradient-border px-4 flex-shrink-0 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${technology})`}}><span className='cardtext'>Business</span></div>
             <div className="bg-blue-800  border-[0.1px] border-blue-400 rounded-xl  w-40 h-22 md:h-25  gradient-border px-4 flex-shrink-0 bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${service})`}}><span className='cardtext'>Insurance</span></div>
